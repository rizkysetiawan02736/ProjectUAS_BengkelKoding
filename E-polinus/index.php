  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"><img class="d-inline-block me-3" src="assets/img/icons/logo.png" alt="" width="100" height="100" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link" href="/E-polinus/pilihDokter">Find a doctor</a></li>
              ...
              <li class="nav-item"><a class="btn btn-lg btn-primary rounded-pill hover-top" href="login.php">Login</a></li>
            </ul>
          </div>
        </div>
      </nav>
      <section class="py-0">
        ...
        <div class="container position-relative">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-md-1 pt-8"><img class="img-fluid" src="assets/img/illustrations/a.png" alt="" /></div>
            <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
              ...
              <p class="mt-3 mb-4 fs-1">E-POLINUS provides progressive, and affordable<br class="d-none d-lg-block" />healthcare, accessible on mobile and online<br class="d-none d-lg-block" />for everyone</p><a class="btn btn-lg btn-primary rounded-pill hover-top" href="pasienBaru.php" role="button">Daftar</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-6 py-lg-8" id="about">
        ...
        <div class="container">
          <div class="row g-xl-0 align-items-center">
            <div class="col-md-6"><img class="img-fluid mb-5 mb-md-0" src="assets/img/illustrations/b.png" width="480" alt="" /></div>
      ...
      <section class="py-6 py-lg-8">
        ...
        <div class="container">
          <div class="row g-xl-0 align-items-center">
            <div class="col-md-6 order-md-1 text-md-end"><img class="img-fluid mb-5 mb-md-0" src="assets/img/illustrations/e.png" width="480" alt="" /></div>
